                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="post">
                                            ...
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Type</label><input class="form-control py-4" id="inputEmailAddress" type="text" aria-describedby="nameHelp" placeholder="Enter 'faculty' for faculties only" name="fdept" value=""/></div>
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Title</label><input class="form-control py-4" id="inputEmailAddress" type="text" aria-describedby="nameHelp" placeholder="Enter Tiltle" name="title" value=""/></div>
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Beginning Date</label><input class="form-control py-4" id="inputEmailAddress" type="date" aria-describedby="emailHelp" placeholder="Enter beginning date" name="bdate"><div>
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">End Date</label><input class="form-control py-4" id="inputEmailAddress" type="date" aria-describedby="emailHelp" placeholder="Enter end date" name="edate"value=""/></div>
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Description</label><textarea class="form-control py-4" id="inputEmailAddress" type="text" aria-describedby="emailHelp" placeholder="Enter description" name="desc"value=""></textarea></div>

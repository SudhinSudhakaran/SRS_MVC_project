                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    ?>
                                        <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Semester Id</label><input required class="form-control py-4" id="inputEmailAddress" type="number" aria-describedby="nameHelp" placeholder="Semester Id" name="sid" value="<?php echo $row['sid']; ?>" readonly/></div>
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Department Name</label>
                                            <input required class="form-control py-4" id="inputEmailAddress" type="text" aria-describedby="nameHelp" placeholder="Enter department name" name="dname" value="<?php echo $row['dept_name']; ?>" readonly/></div>
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Semester</label><input required class="form-control py-4" id="inputEmailAddress" type="number" aria-describedby="nameHelp" placeholder="Enter semester number" name="sno" value="<?php echo $row['dept_sem']; ?>" /></div>
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Subject 1</label><input required class="form-control py-4" id="inputEmailAddress" type="text" aria-describedby="emailHelp" placeholder="Enter subject 1" name="s1" value="<?php echo $row['sub1']; ?>"></div>
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Subject 2</label><input required class="form-control py-4" id="inputEmailAddress" type="text" aria-describedby="emailHelp" placeholder="Enter subject 2" name="s2" value="<?php echo $row['sub2']; ?>"/></div>
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Subject 3</label><input required class="form-control py-4" id="inputEmailAddress" type="text" aria-describedby="emailHelp" placeholder="Enter subject 3" name="s3" value="<?php echo $row['sub3']; ?>"/></div>
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Subject 4</label><input required class="form-control py-4" id="inputEmailAddress" type="text" aria-describedby="emailHelp" placeholder="Enter subject 4" name="s4" value="<?php echo $row['sub4']; ?>"/></div>

                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    ?>
                                        <form method="post"  name="myform" onsubmit="return validateform()">
                                            ...
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Name</label><input class="form-control py-4" id="name" type="text" aria-describedby="nameHelp" placeholder="Enter name" name="name" value="<?php echo $row['fname']; ?>"/></div>
                                            ...
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Mobile</label><input class="form-control py-4" id="mobile" type="text" aria-describedby="emailHelp" placeholder="Enter mobile number" name="mobile" value="<?php echo $row['fmobile']; ?>"/></div>

                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="post">
                                            ...
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Author</label><input required class="form-control py-4" id="inputEmailAddress" type="text" aria-describedby="nameHelp" placeholder="Enter name" name="author" value="<?php echo $_SESSION['author']; ?>" readonly/></div>
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Department</label><input required class="form-control py-4" id="inputEmailAddress" type="text" aria-describedby="nameHelp" placeholder="Enter department" name="fdept" value="<?php echo $_SESSION['fdept']; ?>" readonly/></div>
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Title</label><input required class="form-control py-4" id="inputEmailAddress" type="text" aria-describedby="nameHelp" placeholder="Enter Tiltle" name="title" value=""/></div>
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Beginning Date</label><input required class="form-control py-4" id="inputEmailAddress" type="date" aria-describedby="emailHelp" placeholder="Enter beginning date" name="bdate"><div>
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">End Date</label><input required class="form-control py-4" id="inputEmailAddress" type="date" aria-describedby="emailHelp" placeholder="Enter end date" name="edate"value=""/></div>
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Description</label><textarea required class="form-control py-4" id="inputEmailAddress" type="text" aria-describedby="emailHelp" placeholder="Enter description" name="desc"value=""></textarea></div>
